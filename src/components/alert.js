...
const alert = (
  ...
  return `<div class="px-4 py-2 mb-4 border-l-4 ${border}" role="region" aria-label="${escapeAttr(title)}"${idAttr}><p class="flex items-center font-medium leading-none ${color}">${icon}${escapeHtml(title)}</p>${childrenHtml}${backlink}</div>`;
};
